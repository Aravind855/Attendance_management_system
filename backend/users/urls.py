...
urlpatterns = [
    ...
    path(
        "api/check-unassigned-grades/",
        views.check_unassigned_grades,
        name="check_unassigned_grades",
    ),
    path("api/reset-password/", views.reset_password, name="reset_password"),
    path(
        "api/add-student-by-staff/",
        views.add_student_by_staff,
        name="add_student_by_staff",
    ),
    path(
        "api/check-student-email/",
        views.check_student_email,
        name="check_student_email",
    ),
    path(
